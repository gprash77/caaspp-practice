...
const mathCatOverrides: Record<number, Question> = {
  ...
  24: q(16025, { testType: "cat", subject: "math", claim: 2, domain: "NBT", target: "E", dok: 2, standard: "3.NBT.A.2", type: "multiple-choice", questionText: "A student solves 500 - 275 and gets 335. Which mistake did the student most likely make?", options: [{ label: "A", text: "Added 100 too many" }, { label: "B", text: "Subtracted 200 but added 75" }, { label: "C", text: "Forgot to subtract the hundreds" }, { label: "D", text: "Rounded both numbers first" }], correctAnswer: "B", rubric: "The student identifies a likely subtraction error.", points: 1, explanation: "500 - 200 + 75 = 375, but treating the 75 in the wrong direction is the kind of error shown; the correct answer is 225." }),
