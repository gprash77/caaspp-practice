...
Room 3 wanted to plant herbs, flowers, and vegetables in the empty garden beds beside the library. At first, the students drew a quick plan. They put tall bean poles in the middle, lettuce beside the fence, and tomato plants near the classroom door. The plan looked neat on paper, but Ms. Ramos asked the class to test it before planting.

The students visited the garden at three times during the day. In the morning, the beds near the fence were shady. At noon, the middle of the garden was bright and warm. In the afternoon, the classroom side was shaded by the building. The students also stretched the hose across the path and discovered that it reached the center beds but not the far corner.

"Our first map has a problem," said Theo. "The bean poles would shade the lettuce, and the tomatoes would not get enough afternoon sun."

The class revised the plan. They moved the tall bean poles to the back edge of the garden where they would not shade shorter plants. They placed tomatoes in the sunniest middle bed and put lettuce where it would get cooler morning light. They also left a wide path so students could water plants without stepping over rows.

On planting day, the new map helped the class work in teams. One group planted seeds, one group watered, and one group placed labels. Because the class had checked sunlight, water, and plant height before planting, the garden was easier to care for.

---

**Source 2: Why Garden Plans Matter**

A garden plan is a drawing that shows where plants will grow. A good plan can show sunny places, shady places, paths, water sources, and plant heights. Gardeners use plans because different plants have different needs.

Some plants, such as tomatoes and peppers, usually need many hours of sunlight. Other plants, such as lettuce, can grow well with cooler light during part of the day. Tall plants can create shade, so gardeners often place them where they will not block shorter plants. Gardeners also think about roots. Plants that are too close together may compete for water and space.

Planning can make garden work easier. A wide path lets people carry tools and watering cans safely. A bed near a hose may be easier to water than a bed in a far corner. Labels can help students remember what was planted in each row.

Garden plans can change. After gardeners observe sunlight, soil, and water, they may move plants on the plan before anything goes into the ground. Changing a drawing is much easier than moving plants later. A careful plan helps a garden get off to a strong start.`;
...
const mathCatBase: Question[] = mathCatItems.map((item, index) => {
...
const mathCatOverrides: Record<number, Question> = {
  1: q(16002, { testType: "cat", subject: "math", claim: 2, domain: "OA", target: "D", dok: 2, standard: "3.OA.A.3", type: "grid-match", questionText: "Match each garden arrangement to the equation that shows the total number of plants.", gridRows: ["3 rows of 4 plants", "2 rows of 6 plants", "5 rows of 3 plants"], gridColumns: ["2 x 6 = 12", "5 x 3 = 15", "3 x 4 = 12"], correctAnswer: ["0:2", "1:0", "2:1"], rubric: "The student matches equal-group situations to equations.", points: 1, explanation: "Each row describes groups and items in each group." }),
  4: q(16005, { testType: "cat", subject: "math", claim: 3, domain: "OA", target: "F", dok: 2, standard: "3.OA.B.5", type: "multiple-choice", questionText: "Maya says 4 x 6 is the same as 4 x 3 plus 4 x 3. Why is Maya correct?", options: [{ label: "A", text: "Because 6 can be broken into 3 + 3" }, { label: "B", text: "Because 4 + 6 equals 4 x 6" }, { label: "C", text: "Because 4 x 3 is greater than 4 x 6" }, { label: "D", text: "Because multiplication always makes 3 groups" }], correctAnswer: "A", rubric: "The student explains a distributive property representation.", points: 1, explanation: "4 x 6 can be split into 4 x (3 + 3)." }),
  7: q(16008, { testType: "cat", subject: "math", claim: 3, domain: "NBT", target: "E", dok: 2, standard: "3.NBT.A.1", type: "multiple-choice", questionText: "A student rounds 548 to the nearest hundred and gets 600. Which explanation is best?", options: [{ label: "A", text: "Correct, because 548 is closer to 600 than 500" }, { label: "B", text: "Incorrect, because all numbers with 4 tens round down" }, { label: "C", text: "Incorrect, because 548 is already a hundred" }, { label: "D", text: "Correct, because every number over 500 rounds to 600" }], correctAnswer: "B", rubric: "The student evaluates a rounding explanation.", points: 1, explanation: "548 has 4 tens, so it rounds to 500, not 600." }),
  9: q(16010, { testType: "cat", subject: "math", claim: 1, domain: "NF", target: "F", dok: 2, standard: "3.NF.A.2", type: "text-input", questionText: "A number line from 0 to 1 is divided into 6 equal parts. Enter a fraction that is greater than 2/6 and less than 5/6.", correctAnswer: "3/6", fractionRange: { greaterThan: "2/6", lessThan: "5/6" }, rubric: "The student enters a fraction in the given range.", points: 1, explanation: "Fractions such as 3/6 or 4/6 are between 2/6 and 5/6." }),
  11: q(16012, { testType: "cat", subject: "math", claim: 4, domain: "MD", target: "I", dok: 2, standard: "3.MD.C.7", type: "grid-match", questionText: "Match each garden bed to its area.", gridRows: ["3 feet by 5 feet", "4 feet by 4 feet", "2 feet by 8 feet"], gridColumns: ["15 square feet", "16 square feet", "16 square feet"], correctAnswer: ["0:0", "1:1", "2:2"], rubric: "The student matches rectangles to areas.", points: 1, explanation: "3 x 5 = 15, 4 x 4 = 16, and 2 x 8 = 16." }),
  14: q(16015, { testType: "cat", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.4", type: "line-plot", questionText: "A class measured sprouts in inches: 2, 2, 3, 3, 3, 4, and 5. Make a line plot for the data.", linePlotLabels: ["2", "3", "4", "5"], linePlotMaxDots: 3, correctAnswer: ["0:2", "1:3", "2:1", "3:1"], rubric: "The student places marks for each sprout length.", points: 1, explanation: "There are two 2s, three 3s, one 4, and one 5." }),
  17: q(16018, { testType: "cat", subject: "math", claim: 2, domain: "OA", target: "D", dok: 2, standard: "3.OA.D.8", type: "multiple-choice", questionText: "A garden club has 4 trays with 8 seedlings in each tray. They plant 9 seedlings. Which expression finds how many seedlings are left?", options: [{ label: "A", text: "4 + 8 - 9" }, { label: "B", text: "4 x 8 - 9" }, { label: "C", text: "4 x 9 - 8" }, { label: "D", text: "8 x 9 - 4" }], correctAnswer: "B", rubric: "The student selects an expression for a two-step problem.", points: 1, explanation: "First find 4 groups of 8, then subtract 9 planted seedlings." }),
  21: q(16022, { testType: "cat", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.3", type: "grid-match", dataTable: plantTable, questionText: "Use the garden table. Match each question to its answer.", gridRows: ["Seeds planted on Wednesday", "Plants watered on Monday", "Weeds pulled on Friday"], gridColumns: ["9", "10", "18"], correctAnswer: ["0:1", "1:2", "2:0"], rubric: "The student reads values from a table.", points: 1, explanation: "The table shows 10 seeds Wednesday, 18 plants watered Monday, and 9 weeds Friday." }),
  24: q(16025, { testType: "cat", subject: "math", claim: 2, domain: "NBT", target: "E", dok: 2, standard: "3.NBT.A.2", type: "multiple-choice", questionText: "A student solves 500 - 275 and gets 375. Which mistake did the student most likely make?", options: [{ label: "A", text: "The student subtracted 200 but added 75 instead of subtracting it." }, { label: "B", text: "The student forgot to subtract the hundreds." }, { label: "C", text: "The student rounded both numbers first." }, { label: "D", text: "The student added 500 and 275." }], correctAnswer: "A", rubric: "The student identifies a likely subtraction error.", points: 1, explanation: "500 - 200 + 75 = 375. The correct work is 500 - 200 - 75 = 225." }),
  26: q(16027, { testType: "cat", subject: "math", claim: 4, domain: "G", target: "K", dok: 2, standard: "3.G.A.2", type: "shade-grid", questionText: "Shade 4 of the 8 equal boxes to show one-half of the garden sign.", shadeGrid: { rows: 2, cols: 4, requiredCount: 4 }, correctAnswer: ["0:0", "0:1", "1:0", "1:1"], rubric: "The student shades exactly half of the boxes.", points: 1, explanation: "Four of 8 equal parts is one-half." }),
  28: q(16029, { testType: "cat", subject: "math", claim: 1, domain: "MD", target: "G", dok: 2, standard: "3.MD.A.1", type: "multiple-choice", questionText: "Garden club starts at 2:35 p.m. and ends at 3:10 p.m. Which counting method finds the elapsed time?", options: [{ label: "A", text: "25 minutes to 3:00, then 10 more minutes" }, { label: "B", text: "35 minutes to 3:00, then 10 more minutes" }, { label: "C", text: "10 minutes to 3:00, then 25 more minutes" }, { label: "D", text: "2 hours and 35 minutes" }], correctAnswer: "A", rubric: "The student identifies a valid elapsed-time strategy.", points: 1, explanation: "From 2:35 to 3:00 is 25 minutes, then 10 more minutes to 3:10." }),
  31: q(16032, { testType: "cat", subject: "math", claim: 3, domain: "G", target: "K", dok: 2, standard: "3.G.A.1", type: "multi-select", questionText: "Select two statements that are always true.", options: [{ label: "A", text: "A rectangle has 4 sides." }, { label: "B", text: "Every quadrilateral is a square." }, { label: "C", text: "A triangle has 3 sides." }, { label: "D", text: "Every pentagon has 6 sides." }], correctAnswer: ["A", "C"], rubric: "The student identifies true shape statements.", points: 1, explanation: "Rectangles have 4 sides, and triangles have 3 sides." }),
};

const mathCat: Question[] = mathCatBase.map((question, index) => mathCatOverrides[index] ?? question);

const mathPt: Question[] = [
  q(16050, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.3", type: "multiple-choice", dataTable: plantTable, studentDirections: "The class is planning Garden Care Week. Use the table to answer questions about planting, watering, and clearing weeds.", questionText: "The class wants to know how much planting work was finished at the start of the week. How many seeds were planted on Monday and Tuesday in all?", options: [{ label: "A", text: "20" }, { label: "B", text: "24" }, { label: "C", text: "26" }, { label: "D", text: "30" }], correctAnswer: "C", rubric: "The student adds two values from the table.", points: 1, explanation: "12 + 14 = 26 seeds." }),
  q(16051, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.3", type: "text-input", dataTable: plantTable, studentDirections: "The class is planning Garden Care Week. Use the table to answer questions about planting, watering, and clearing weeds.", questionText: "The class watered more plants as the week went on. How many more plants were watered on Friday than on Monday?", correctAnswer: "8", rubric: "The student subtracts two table values.", points: 1, explanation: "26 - 18 = 8 more plants." }),
  q(16052, { testType: "pt", subject: "math", claim: 2, domain: "OA", target: "D", dok: 2, standard: "3.OA.D.8", type: "multiple-choice", dataTable: plantTable, studentDirections: "The class is planning Garden Care Week. Use the table to answer questions about planting, watering, and clearing weeds.", questionText: "On Saturday, the class packs 4 trays with 6 seedlings each. They give 5 seedlings to another class. How many seedlings are left for their garden?", options: [{ label: "A", text: "19" }, { label: "B", text: "20" }, { label: "C", text: "24" }, { label: "D", text: "29" }], correctAnswer: "A", rubric: "The student solves a two-step problem.", points: 1, explanation: "4 x 6 = 24, and 24 - 5 = 19." }),
  q(16053, { testType: "pt", subject: "math", claim: 1, domain: "MD", target: "I", dok: 2, standard: "3.MD.C.7", type: "grid-match", dataTable: plantTable, studentDirections: "The class is planning Garden Care Week. Use the table to answer questions about planting, watering, and clearing weeds.", questionText: "Match each garden bed to its area.", gridRows: ["Tomato bed: 5 feet by 4 feet", "Herb bed: 3 feet by 6 feet", "Flower bed: 2 feet by 7 feet"], gridColumns: ["14 square feet", "18 square feet", "20 square feet"], correctAnswer: ["0:2", "1:1", "2:0"], rubric: "The student matches each rectangle to its area.", points: 1, explanation: "5 x 4 = 20, 3 x 6 = 18, and 2 x 7 = 14." }),
  q(16054, { testType: "pt", subject: "math", claim: 4, domain: "OA", target: "E", dok: 3, standard: "3.OA.D.8", type: "table-input", dataTable: plantTable, tableColumns: ["Wednesday", "Thursday", "Friday"], tableRowLabel: "New seedlings planted", tableMinSumExclusive: 60, studentDirections: "The class is planning Garden Care Week. Use the table to answer questions about planting, watering, and clearing weeds.", questionText: "The class wants the total number of new seedlings planted on Wednesday, Thursday, and Friday to be greater than 60. Enter one possible number for each day.", correctAnswer: ["21", "20", "20"], rubric: "The student enters nonnegative values with a total greater than 60.", points: 1, explanation: "Any three nonnegative numbers with a total greater than 60 are valid; 21 + 20 + 20 = 61." }),
];
