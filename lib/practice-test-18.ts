...
const mathCat: Question[] = mathRows.map((item, index) => {
...
const mathPt: Question[] = [
  ...
  q(18054, { testType: "pt", subject: "math", claim: 3, domain: "OA", target: "F", dok: 2, standard: "3.OA.B.5", type: "multi-select", dataTable: shoreTable, studentDirections: "Use the shore table to answer the questions.", questionText: "Which two equations can help find 4 x 9?", options: [{ label: "A", text: "9 + 9 + 9 + 9 = 36" }, { label: "B", text: "(4 x 5) + (4 x 4) = 36" }, { label: "C", text: "9 - 4 = 5" }, { label: "D", text: "4 + 9 = 13" }], correctAnswer: ["A", "B"], rubric: "The student identifies valid multiplication representations.", points: 1, explanation: "Both equations show 4 groups of 9." }),
];
