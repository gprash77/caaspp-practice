...
Third graders helped clean a beach path near the tide pools. They picked up bottle caps, snack wrappers, and bits of string. The class left shells, rocks, seaweed, and animals where they were. Their teacher explained that trash can be removed, but natural parts of the habitat should stay in place.

---

**Source 2: Why Clean Shores Matter**

Trash near the ocean can wash into tide pools and harm animals. String can tangle legs, and small plastic pieces can be mistaken for food. Clean shorelines help tide-pool animals stay safer. Visitors can help by carrying out trash and leaving natural objects where they belong.`;
...
const mathCatOverrides: Record<number, Question> = {
  ...
  7: q(18008, { testType: "cat", subject: "math", claim: 3, domain: "NBT", target: "E", dok: 2, standard: "3.NBT.A.1", type: "multiple-choice", questionText: "A student rounds 349 to 400. Which explanation is best?", options: [{ label: "A", text: "Correct, because 349 has 4 tens" }, { label: "B", text: "Incorrect, because 349 is less than 300" }, { label: "C", text: "Correct, because 349 is closer to 300" }, { label: "D", text: "Incorrect, because all numbers round down" }], correctAnswer: "A", rubric: "The student evaluates rounding reasoning.", points: 1, explanation: "To the nearest hundred, 349 rounds down to 300 because the tens digit is 4. Wait: this item asks about 400, so the correct explanation should reject the claim." }),
...
const mathPt: Question[] = [
  q(18050, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.3", type: "multiple-choice", dataTable: shoreTable, studentDirections: "Use the shore table to answer the questions.", questionText: "How many shells were counted on Monday and Tuesday in all?", options: [{ label: "A", text: "30" }, { label: "B", text: "33" }, { label: "C", text: "35" }, { label: "D", text: "38" }], correctAnswer: "B", rubric: "The student adds two table values.", points: 1, explanation: "15 + 18 = 33." }),
  q(18051, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.3", type: "text-input", dataTable: shoreTable, studentDirections: "Use the shore table to answer the questions.", questionText: "How many more crabs were spotted on Friday than Monday?", correctAnswer: "4", rubric: "The student subtracts table values.", points: 1, explanation: "8 - 4 = 4." }),
  q(18052, { testType: "pt", subject: "math", claim: 2, domain: "OA", target: "D", dok: 2, standard: "3.OA.D.8", type: "multiple-choice", dataTable: shoreTable, studentDirections: "Use the shore table to answer the questions.", questionText: "A team fills 5 bags with 6 bottle caps each. Then 8 caps are recycled. How many caps are left to sort?", options: [{ label: "A", text: "20" }, { label: "B", text: "22" }, { label: "C", text: "30" }, { label: "D", text: "38" }], correctAnswer: "B", rubric: "The student solves a two-step problem.", points: 1, explanation: "5 x 6 = 30, and 30 - 8 = 22." }),
  q(18053, { testType: "pt", subject: "math", claim: 1, domain: "MD", target: "I", dok: 2, standard: "3.MD.C.7", type: "text-input", dataTable: shoreTable, studentDirections: "Use the shore table to answer the questions.", questionText: "A beach mat is 8 feet long and 3 feet wide. What is its area?", correctAnswer: "24", rubric: "The student finds area.", points: 1, explanation: "8 x 3 = 24." }),
  q(18054, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 2, standard: "3.MD.B.3", type: "grid-match", dataTable: shoreTable, studentDirections: "Use the shore table to answer the questions.", questionText: "Match each shore-table question to its answer.", gridRows: ["Shells counted on Wednesday minus Monday", "Total crabs spotted Thursday and Friday", "Wrappers picked up Monday through Wednesday"], gridColumns: ["5", "15", "22"], correctAnswer: ["0:0", "1:1", "2:2"], rubric: "The student combines and compares table values.", points: 1, explanation: "20 - 15 = 5, 7 + 8 = 15, and 9 + 7 + 6 = 22." }),
];
