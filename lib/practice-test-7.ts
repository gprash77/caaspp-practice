...
export const practiceTest7Questions: Question[] = [
  ...
  },
  {
    ...
    "correctAnswer": "A strong response explains how people can learn to value places they first overlook. It should use details from the story to show how the moonlight garden became meaningful when students cared for it, and details from the article to show how wetlands help wildlife and people even if they seem unimportant at first.",
