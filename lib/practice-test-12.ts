...
const practiceTest12ElaCAT: Question[] = [
  ...
  },
  {
    ...
    passageTitle: "The Broken Robot",
    passageAuthor: "Nina Park",
    questionText: "Which TWO details show that Ava felt worried when Pip would not move?",
    options: [
      { label: "A", text: "She stared at Pip and said, \"We need him for the parade.\"" },
      { label: "B", text: "She laughed and sat down on the floor." },
      { label: "C", text: "She asked the class to look step by step for the problem." },
      { label: "D", text: "She said the parade could not matter anymore." },
      { label: "E", text: "She walked away from the robot." },
    ],
    correctAnswer: ["A", "C"],
    rubric: "The student selects the two details that show Ava's worried response.",
    points: 1,
  },
  {
  ...
  },
  {
    ...
    passageTitle: "The Broken Robot",
    passageAuthor: "Nina Park",
    questionText: "If the story had a picture at the end, which TWO details would most likely appear?",
    options: [
      { label: "A", text: "Pip rolling with the class sign during the parade" },
      { label: "B", text: "Ms. Vega sitting alone in the classroom" },
      { label: "C", text: "Classmates cheering after the robot starts moving again" },
      { label: "D", text: "The empty gym before school" },
      { label: "E", text: "A lunch tray tipped over near the robot" },
    ],
    correctAnswer: ["A", "C"],
    rubric: "The student selects the two details that fit the story ending.",
    points: 1,
  },
  {
  ...
  },
  {
    ...
    passage: simpleMachinesPassage,
    passageTitle: "How Simple Machines Help People Work",
    questionText: "Which TWO statements explain how a ramp helps people?",
    options: [
      { label: "A", text: "It helps move objects to a higher place." },
      { label: "B", text: "It can make lifting a heavy object easier." },
      { label: "C", text: "It cuts things apart." },
      { label: "D", text: "It holds flags in place." },
      { label: "E", text: "It is another name for a pulley wheel." },
    ],
    correctAnswer: ["A", "B"],
    rubric: "The student selects the two statements that explain how a ramp helps.",
    points: 1,
  },
  {
  ...
  },
  {
    ...
    passage: simpleMachinesPassage,
    passageTitle: "How Simple Machines Help People Work",
    questionText: "Match each simple machine to the description that fits it.",
    gridRows: [
      "lever",
      "pulley",
      "wheel and axle",
    ...
    gridColumns: [
      "helps move or lift using a wheel and rope",
      "helps move heavy things using a slanted surface",
      "helps turn or roll around a center rod",
      "moves on a bar and pivot point",
    ],
    correctAnswer: ["0:3", "1:0", "2:2", "3:1"],
    rubric: "The student correctly matches each simple machine to its description.",
    points: 1,
  },
  {
    id: 12120, practiceTest: 12, testType: "cat", subject: "ela", grade: 3,
    claim: 1, domain: "RI", target: "D", dok: 2, standard: "RI.3.9",
    type: "multiple-choice",
    passage: simpleMachinesPassage,
    passageTitle: "How Simple Machines Help People Work",
  ...
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "The helpers carried the sign carefully." },
      { label: "D", text: "we fixed the wheel before lunch" },
      { label: "E", text: "The helpers carried the sign carefully" },
    ],
    correctAnswer: ["B", "C"],
  ...
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "The machine used wheels, wires, and lights." },
      { label: "E", text: "The machine used wheels wires, and lights." },
    ],
    correctAnswer: ["B", "D"],
    rubric: "The student selects the two sentences with correct comma use in a series.",
    points: 1,
  },
  {
  ...
  },
  {
    ...
    claim: 3, domain: "SL", target: "A", dok: 2, standard: "SL.3.3",
    type: "multiple-choice",
  ...
  },
  {
    ...
    passage: pizzaPresentation,
    passageTitle: "Pizza Around the World",
    questionText: "Match each detail to whether it is supported by the presentation or not supported.",
    gridRows: [
      "Pizza can be made with many different toppings.",
      "Only one country knows how to make pizza.",
      "The presentation shares another way of looking at pizza.",
      "The speaker explains how to open a restaurant.",
    ],
    gridColumns: ["Supported by the presentation", "Not supported by the presentation"],
    correctAnswer: ["0:0", "1:1", "2:0", "3:1"],
    rubric: "The student correctly identifies which ideas are supported by the presentation.",
    points: 1,
  },
  {
    ...
    claim: 3, domain: "SL", target: "A", dok: 2, standard: "SL.3.2",
    type: "multi-select",
    questionText: "After listening to the presentations, which TWO details would best help a student explain that tools and inventions can solve problems? Select two answers.",
    options: [
      { label: "A", text: "Pip rolled again after classmates found the problem step by step." },
      { label: "B", text: "The speaker listed favorite pizza toppings." },
      { label: "C", text: "Edward became the first American to rise into the air in a hot-air balloon." },
      { label: "D", text: "The gym floor was shiny." },
      { label: "E", text: "The parade was held after lunch." },
    ],
    correctAnswer: ["A", "C"],
    rubric: "The student selects the two presentation details that best support the idea that tools and inventions solve problems.",
    points: 1,
  },
];
