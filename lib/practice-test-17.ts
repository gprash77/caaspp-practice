...
Students at Maple School opened a time capsule that had been sealed in 1985. The metal box was dusty, but the objects inside were dry and safe. The class found a cafeteria menu, a class photograph, a yellow pencil, a school newsletter, and a letter written by students.

The cafeteria menu surprised everyone. It listed vegetable soup, milk, peaches, and a square of cornbread. The class photograph showed students standing in front of the old library doors. Some students wore striped shirts, and several had large plastic glasses. The newsletter described a jump-rope contest and a book fair held in the gym.

The letter was the most helpful item. It explained why the students had chosen each object. The menu showed what children ate at school. The pencil showed a tool students used every day. The newsletter showed school events that mattered to them. The photograph helped future students see what the class looked like.

After studying the objects, today's students made a display for the hallway. They wrote labels for each item and included one question for visitors to think about: "What object from our school would help students in the future understand us?"

---

**Source 2: Why Time Capsules Teach**

A time capsule is a container filled with objects from one time period. People seal it and open it years later. The objects inside can help future readers learn about daily life, school, work, celebrations, and community events.

Objects in a time capsule are clues. A menu can show what people ate. A photograph can show clothing, buildings, and tools. A ticket or program can show where people went for fun. A letter can explain what people cared about and what they hoped others would remember.

Time capsules teach best when they include notes or labels. Without labels, future readers may not know why an object mattered. For example, a plain pencil might not seem important until a note explains that students used pencils every day before most classroom work was done on computers. A photograph may be more useful if the people, place, and date are named.

Choosing items for a time capsule takes careful thinking. The best objects are not always the most expensive. They are objects that tell clear stories about a time and place.`;
...
const mathPt: Question[] = [
  q(17050, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 3, standard: "3.MD.B.3", type: "multiple-choice", dataTable: museumTable, studentDirections: "The museum is preparing for Student History Week. Use the table to answer questions about visitors, maps, and exhibit setup.", questionText: "The museum wants to know how many student visitors came during the two busiest school days shown. Tuesday had 28 student visitors and Wednesday had 32. How many came on those two days in all?", options: [{ label: "A", text: "50" }, { label: "B", text: "56" }, { label: "C", text: "60" }, { label: "D", text: "64" }], correctAnswer: "C", rubric: "The student adds two table values.", points: 1, explanation: "28 + 32 = 60." }),
  q(17051, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 3, standard: "3.MD.B.3", type: "text-input", dataTable: museumTable, studentDirections: "The museum is preparing for Student History Week. Use the table to answer questions about visitors, maps, and exhibit setup.", questionText: "The museum handed out more maps on Friday than Monday. How many more maps were handed out on Friday?", correctAnswer: "12", rubric: "The student subtracts two table values.", points: 1, explanation: "30 - 18 = 12." }),
  q(17052, { testType: "pt", subject: "math", claim: 2, domain: "OA", target: "D", dok: 3, standard: "3.OA.D.8", type: "multiple-choice", dataTable: museumTable, studentDirections: "The museum is preparing for Student History Week. Use the table to answer questions about visitors, maps, and exhibit setup.", questionText: "A guide arranges 6 rows of 7 chairs for a presentation. Then 5 broken chairs are removed. How many chairs are ready for visitors?", options: [{ label: "A", text: "37" }, { label: "B", text: "40" }, { label: "C", text: "42" }, { label: "D", text: "47" }], correctAnswer: "A", rubric: "The student solves a two-step problem.", points: 1, explanation: "6 x 7 = 42, and 42 - 5 = 37." }),
  q(17053, { testType: "pt", subject: "math", claim: 1, domain: "MD", target: "I", dok: 2, standard: "3.MD.C.7", type: "grid-match", dataTable: museumTable, studentDirections: "The museum is preparing for Student History Week. Use the table to answer questions about visitors, maps, and exhibit setup.", questionText: "Match each display board to its area.", gridRows: ["Main board: 7 feet by 6 feet", "Photo board: 5 feet by 8 feet", "Map board: 4 feet by 9 feet"], gridColumns: ["36 square feet", "40 square feet", "42 square feet"], correctAnswer: ["0:2", "1:1", "2:0"], rubric: "The student matches each rectangle to its area.", points: 1, explanation: "7 x 6 = 42, 5 x 8 = 40, and 4 x 9 = 36." }),
  q(17054, { testType: "pt", subject: "math", claim: 4, domain: "MD", target: "H", dok: 3, standard: "3.MD.B.3", type: "grid-match", dataTable: museumTable, studentDirections: "The museum is preparing for Student History Week. Use the table to answer questions about visitors, maps, and exhibit setup.", questionText: "Match each museum-table question to its answer.", gridRows: ["Total adult visitors on Thursday and Friday", "Student visitors on Friday minus adult visitors on Friday", "Maps handed out Monday through Wednesday"], gridColumns: ["16", "38", "62"], correctAnswer: ["0:1", "1:0", "2:2"], rubric: "The student combines and compares values from the table.", points: 1, explanation: "18 + 20 = 38, 36 - 20 = 16, and 18 + 20 + 24 = 62." }),
];
