...
const mathCat: Question[] = mathData.map((item, index) => {
...
const mathPt: Question[] = [
  ...
  q(17054, { testType: "pt", subject: "math", claim: 3, domain: "OA", target: "F", dok: 3, standard: "3.OA.B.5", type: "multi-select", dataTable: museumTable, studentDirections: "Use the museum table to answer the questions.", questionText: "Which two equations can help find 6 x 12?", options: [{ label: "A", text: "(6 x 10) + (6 x 2) = 72" }, { label: "B", text: "12 + 6 = 18" }, { label: "C", text: "12 + 12 + 12 + 12 + 12 + 12 = 72" }, { label: "D", text: "72 - 6 = 66" }], correctAnswer: ["A", "C"], rubric: "The student selects valid multiplication representations.", points: 1, explanation: "Both choices show 6 groups of 12." }),
];
