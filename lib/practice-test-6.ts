...
export const practiceTest6Questions: Question[] = [
  ...
  },
  {
    ...
    "correctAnswer": "A strong response explains why waterways matter to communities by showing how people depend on them in daily life and how they shape the land around them. It should use details from the story about the bridge and lantern walk, and details from the article about rivers shaping land and helping communities.",
