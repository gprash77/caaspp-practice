...
test.describe("Grade 4 Test 1 official baseline", () => {
  ...
  test("renders and navigates all 5 Math PT items", async ({ page }) => {
    ...
    await page.locator(".tds-progress-dots .tds-dot").nth(3).click();
  ...
  test("renders and navigates all 30 ELA CAT items with exact listening transcripts", async ({ page }) => {
    ...
    await page.locator(".tds-progress-dots .tds-dot").nth(21).click();
    ...
    await page.locator(".tds-progress-dots .tds-dot").nth(24).click();
  ...
  test("supports every new Math interaction family", async ({ page }) => {
    ...
    await dots.nth(17).click();
    await page.locator(".symmetry-canvas").scrollIntoViewIfNeeded();
    await page.locator(".symmetry-canvas").click({ force: true });
    await expect(page.locator(".symmetry-canvas")).toHaveAttribute("aria-pressed", "true");

    await dots.nth(25).click();
